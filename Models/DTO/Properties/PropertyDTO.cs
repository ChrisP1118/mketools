...
namespace MkeAlerts.Web.Models.DTO.Properties
{
    public class PropertyDTO
    {
        ...
        [MaxLength(4)] public string CONVEY_DATE { get; set; }
        ...
        [MaxLength(2)] public string GEO_ALDER_OLD { get; set; }
        [MaxLength(2)] public string GEO_BI_MAINT { get; set; }
        ...
        [MaxLength(9)] public string GEO_ZIP_CODE { get; set; }
        ...
        [MaxLength(2)] public string LAND_USE_GP { get; set; }
        [MaxLength(6)] public string LAST_NAME_CHG { get; set; }
        [MaxLength(6)] public string LAST_VALUE_CHG { get; set; }
        ...
        [MaxLength(23)] public string OWNER_CITY_STATE { get; set; }
        ...
        [MaxLength(1)] public string RAZE_STATUS { get; set; }
