...
{
    public class ImportStreetsJob : LoggedJob
    {
        private readonly IEntityWriteService<Street, string> _streetWriteService;

        public ImportStreetsJob(IConfiguration configuration, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, IMailerService mailerService, IJobRunService jobRunService, ILogger<ImportStreetsJob> logger, IEntityWriteService<Street, string> streetWriteService)
