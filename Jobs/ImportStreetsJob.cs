...
namespace MkeAlerts.Web.Jobs
{
    public class ImportStreetsJob : Job
    {
        ...
        public ImportStreetsJob(IConfiguration configuration, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, ILogger<ImportStreetsJob> logger, IEntityWriteService<Street, string> streetWriteService)
        ...
        public async Task Run()
        {
            ...
            string fileName = await PackageUtilities.DownloadPackageFile(_logger, "dime", "ZIP");
