...
namespace MkeAlerts.Web.Migrations
{
    ...
    [Migration("20200428145038_BoundsPrecision")]
    partial class BoundsPrecision
    {
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.Accounts.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "3b653776-39db-41b4-baf5-a05e154535fe",
                            Name = "SiteAdmin",
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.Accounts.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f0fd19dc-b858-4a40-b84e-2357924483e2",
                            Email = "cwilson@mkealerts.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "cwilson@mkealerts.com",
                            NormalizedUserName = "cwilson@mkealerts.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEJ20llgKcuy+lVCGninGyRtrS9USX8Zo6YAF53tAKtLXgc2RPntdBadX7Kv5UDK8ww==",
