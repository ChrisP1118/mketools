...
namespace MkeAlerts.Web.Migrations
{
    ...
    [Migration("20200429204419_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.Accounts.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "7dfc2af2-df08-48e1-af40-d6187afab59f",
                            Name = "SiteAdmin",
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.Accounts.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6488f362-61e4-4218-97d4-beb3d1cbe643",
                            Email = "cwilson@mkealerts.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "cwilson@mkealerts.com",
                            NormalizedUserName = "cwilson@mkealerts.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEMP1yMgQRYqGP53J1VduKBIx+HJT1X8VVXPrNWHfdjy+yxyI6o92TyxYhJoVQfLczw==",
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.StringReference", b =>
                {
                    b.Property<string>("Value")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("StringReference");
                });
