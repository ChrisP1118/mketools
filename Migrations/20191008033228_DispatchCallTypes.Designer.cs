...
namespace MkeAlerts.Web.Migrations
{
    ...
    [Migration("20191008033228_DispatchCallTypes")]
    partial class DispatchCallTypes
    {
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.Accounts.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "2d099274-e775-43c3-87a5-0ac562c64c7a",
                            Name = "SiteAdmin",
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.Accounts.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b1a9e08f-2e32-4a98-8310-e65f1ad1be6a",
                            Email = "admin@mkealerts.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "admin@mkealerts.com",
                            NormalizedUserName = "admin@mkealerts.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEHYbw/ZDJqyPKPbaaGnnzl2q7BW/ANN+RoWe1pgUQXohBKCGU9ECEmdD5t+sxNA+rA==",
