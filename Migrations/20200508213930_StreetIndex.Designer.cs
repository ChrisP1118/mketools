...
namespace MkeTools.Web.Migrations
{
    ...
    [Migration("20200508213930_StreetIndex")]
    partial class StreetIndex
    {
            ...
            modelBuilder.Entity("MkeTools.Web.Models.Data.Accounts.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "dd418b15-eb5a-47f6-a15a-b0fa5dd150a9",
                            Name = "SiteAdmin",
            ...
            modelBuilder.Entity("MkeTools.Web.Models.Data.Accounts.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c99eb1ca-a180-4b7e-986c-fd8927512592",
                            Email = "cwilson@mke.tools",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "cwilson@mke.tools",
                            NormalizedUserName = "cwilson@mke.tools",
                            PasswordHash = "AQAAAAEAACcQAAAAEJZb/Wiy9xco9RUsPA+ioCQN/ooQiXPe9XlCSMZpfUMHOATTzYuUOyYwKiwjlbUJRQ==",
