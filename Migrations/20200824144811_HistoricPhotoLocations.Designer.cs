...
namespace MkeTools.Web.Migrations
{
    ...
    partial class HistoricPhotoLocations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.Accounts.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "00db390d-6181-44ab-9697-df174beee575",
                            Name = "SiteAdmin",
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.Accounts.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "856a96ba-3b03-4ea9-8bd9-70d5ae15aa43",
                            Email = "cwilson@mkealerts.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "cwilson@mkealerts.com",
                            NormalizedUserName = "cwilson@mkealerts.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEHljcP9k9b3fDuh/f+byt4OrG95sHktMlMIaWpPuAcChB83unfgG+7dWU0O6DC1n/Q==",
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.HistoricPhotos.HistoricPhoto", b =>
                {
                    ...
                    b.Property<Guid?>("HistoricPhotoLocationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("HistoricPhotoLocationId");

                    b.ToTable("HistoricPhotos");
                });

            modelBuilder.Entity("MkeAlerts.Web.Models.Data.HistoricPhotos.HistoricPhotoLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("HistoricPhotoLocations");
                });
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.HistoricPhotos.HistoricPhoto", b =>
                {
                    b.HasOne("MkeAlerts.Web.Models.Data.HistoricPhotos.HistoricPhotoLocation", "HistoricPhotoLocation")
                        .WithMany("HistoricPhotos")
                        .HasForeignKey("HistoricPhotoLocationId");
                });
