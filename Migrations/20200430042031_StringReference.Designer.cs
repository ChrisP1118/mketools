...
namespace MkeAlerts.Web.Migrations
{
    ...
    [Migration("20200430042031_StringReference")]
    partial class StringReference
    {
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.Accounts.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "59589b40-bfd3-4db6-8cb6-d5c6442b850c",
                            Name = "SiteAdmin",
            ...
            modelBuilder.Entity("MkeAlerts.Web.Models.Data.Accounts.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "dcc9c42f-78fa-4753-9edf-f5baab2adb3a",
                            Email = "cwilson@mkealerts.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "cwilson@mkealerts.com",
                            NormalizedUserName = "cwilson@mkealerts.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEHkM3Tbv0Nd5gs62b3ZVTE4NAqWh/xtFjcUAfXiDtiaBpjTy+h522CfTLnCxGR8kag==",
