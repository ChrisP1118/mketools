    ...
    <b-row>
      <b-col lg="4" xl="6" class="mb-3">
        <div class="explore-map-wrapper">
          <l-map class="explore-map" :zoom="zoom" :center="center" @update:zoom="zoomUpdated" @update:center="centerUpdated" @update:bounds="boundsUpdated" @ready="refreshItems" :max-bounds="maxBounds">
